  ...
  },
  {
    ...
    config = function()
      require("competibest").setup {
        ...
        received_problems_path = "$(HOME)/Documents/Programming/Competitive/$(CONTEST)/$(PROBLEM)/main.$(FEXT)",
        received_problems_prompt_path = false,
        received_contests_directory = "$(HOME)/Documents/Programming/Competitive/$(CONTEST)",
